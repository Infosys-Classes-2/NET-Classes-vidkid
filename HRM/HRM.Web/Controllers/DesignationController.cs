...
namespace HRM.Web.Controllers
{
    public class DesignationController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Established")] Designation designation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Established")] Designation designation)
        {
